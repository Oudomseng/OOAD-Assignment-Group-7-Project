...
Public Class frmBorrower
    ...
    Private Sub btn_delete_Click(ByVal sender As System.Object, ByVal e As System.EventArgs) Handles btn_delete.Click
        ...
        If MessageBox.Show("Are you sure you want to delete this borrower?", "Delete", MessageBoxButtons.YesNo, MessageBoxIcon.Warning) = DialogResult.Yes Then
    ...
    Private Sub btnCard_Click(sender As Object, e As EventArgs) Handles btnCard.Click
        With frmLibraryCard
            ...
            reports(sql, "rptLibrary", .CrystalReportViewer1)
            .ShowDialog()
        End With
    End Sub
End Class